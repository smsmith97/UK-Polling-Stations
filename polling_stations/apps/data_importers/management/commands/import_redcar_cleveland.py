...
class Command(BaseXpressDemocracyClubCsvImporter):
    ...
    def station_record_to_dict(self, record):
        # Salvation Army Hall Bankfields Court Bankfields Road Flatts Lane Normanby TS6 0NB
        if record.polling_place_id == "15894":
            record = record._replace(polling_place_postcode="TS6 0NP")
